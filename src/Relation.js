...
export const hasOne = (model: Model<*, *>, defaultLabel?: string) => (target: any, name: string) => {
  if (!target._hasOne) {
    target._hasOne = [];
  }
...
export class Relation {
  ...
  constructor(type: RelationType, src: Model<*, *>, dest: Model<*, *>, propertyName: string, defaultLabel?: string) {
    this.type = type;
    this.src = src;
    this.dest = dest;
  ...
  addHasOneToInstance(instance: ModelInstance<*>): any {
    const accessors = {
      [this.propertyName]: {
        get: (label?: string) => HasOne.get.bind(this, instance, label ? label : this.defaultLabel)(),
        update: (props: any, label?: string) => HasOne.update.bind(this, instance, label ? label : this.defaultLabel)(props),
        create: (props: any, label?: string) => HasOne.create.bind(this, instance, label ? label : this.defaultLabel)(props),
        add: (destInstance: ModelInstance<*>, label?: string) => HasOne.add.bind(this, instance, label ? label : this.defaultLabel)(destInstance),
        remove: (label?: string) => HasOne.remove.bind(this, instance, label ? label : this.defaultLabel)(),
        hasOne: (label?: string) => HasOne.hasOne.bind(this, instance, label ? label : this.defaultLabel)(),
      },
    };
